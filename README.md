...
`excludeFinalStations`           | <p>An array of final stop names you want to exclude from the displayed departures.</p><p>**Type** `array`<br>**Example** `[ "central station", "plaza" ]`<br>**Default value** `[]`</p>
