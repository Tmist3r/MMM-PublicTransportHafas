...
| `excludeFinalStations`           | <p>An array of final stop names you want to exclude from the displayed departures.</p><p>**Type:** `array`<br>**Example:** `[ "Central Station", "Plaza" ]`<br>**Default value:** `[]`</p><p>**Note:** The comparison is case-sensitive and matches the `direction` value returned by HAFAS exactly.</p>|
